    ...
    return <>
        ...
        `}>
            <div className="flex justify-between items-center gap-4">
                <h2 className="font-medium text-xl">Realizar Informe</h2>
            ...
            <div className="flex gap-4 justify-end mt-2">
                ...
                <button className="transition-base rounded-md w-[200px] bg-[#008080] text-white px-2 py-2 shadow active:brightness-[.90] active:shadow-inner hover:brightness-95 hover:shadow-none">Realizar Informe</button>
            </div>
