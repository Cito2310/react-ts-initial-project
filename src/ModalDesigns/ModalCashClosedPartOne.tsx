    ...
    return <>
        ...
        `}>
            ...
            <div className="flex flex-col">
                <div className="flex flex-col gap-4">
                    <div className="flex gap-4">
                        <label className="text-[#536464] px-1">Billetes de 10 : </label>
                        <input onChange={()=>{}} className="grow border-b-2 border-[#d5e0e0] px-1 py outline-none focus:border-[#7e9292] transition-base" value={"0"}/>
                    </div>

                    <div className="flex gap-4">
                        <label className="text-[#536464] px-1">Billetes de 20 : </label>
                        <input onChange={()=>{}} className="grow border-b-2 border-[#d5e0e0] px-1 py outline-none focus:border-[#7e9292] transition-base" value={"0"}/>
                    </div>

                    <div className="flex gap-4">
                        <label className="text-[#536464] px-1">Billetes de 50 : </label>
                        <input onChange={()=>{}} className="grow border-b-2 border-[#d5e0e0] px-1 py outline-none focus:border-[#7e9292] transition-base" value={"0"}/>
                    </div>

                    <div className="flex gap-4">
                        <label className="text-[#536464] px-1">Billetes de 100 : </label>
                        <input onChange={()=>{}} className="grow border-b-2 border-[#d5e0e0] px-1 py outline-none focus:border-[#7e9292] transition-base" value={"0"}/>
                    </div>

                    <div className="flex gap-4">
                        <label className="text-[#536464] px-1">Billetes de 200 : </label>
                        <input onChange={()=>{}} className="grow border-b-2 border-[#d5e0e0] px-1 py outline-none focus:border-[#7e9292] transition-base" value={"0"}/>
                    </div>

                    <div className="flex gap-4">
                        <label className="text-[#536464] px-1">Billetes de 500 : </label>
                        <input onChange={()=>{}} className="grow border-b-2 border-[#d5e0e0] px-1 py outline-none focus:border-[#7e9292] transition-base" value={"0"}/>
                    </div>

                    <div className="flex gap-4">
                        <label className="text-[#536464] px-1">Billetes de +1000 : </label>
                        <input onChange={()=>{}} className="grow border-b-2 border-[#d5e0e0] px-1 py outline-none focus:border-[#7e9292] transition-base" value={"0"}/>
                    </div>
            ...
            <div className="flex gap-4 justify-end">
                ...
                <button className="transition-base rounded-md w-[140px] bg-[#008080] text-white px-2 py-2 shadow active:brightness-[.90] active:shadow-inner hover:brightness-95 hover:shadow-none">Continuar</button>
            </div>
